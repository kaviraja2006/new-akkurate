...
export default function CallToActionSection() {
    return (
        <section className="relative overflow-hidden bg-[#e5e9f2] pt-6 pb-0 lg:pt-8 lg:pb-0">
            ...
            <div className="relative mx-auto grid max-w-[1320px] grid-cols-1 items-end gap-8 px-6 lg:grid-cols-12">
                <div className="relative lg:col-span-5">
                    <div className="relative mx-auto h-[500px] w-full max-w-[600px] lg:h-[560px] lg:max-w-[700px]">
                        <Image
                            src="https://res.cloudinary.com/ddnxhn442/image/upload/v1771569701/flipped_one_oqhmgf.png"
                            alt="Expert consultant"
                            width={760}
                            height={980}
                            className="absolute -bottom-1 left-1/2 h-auto w-[132%] -translate-x-1/2 object-contain"
                            sizes="(max-width: 1024px) 98vw, 760px"
                        />
                ...
                <div className="pb-4 lg:col-span-7 lg:pb-8 lg:pl-8">
